...
public class CreditExecutor extends CommandExecutor{

    public CreditExecutor(BankingService bankingService, OutputPrinter outputPrinter){
    ...
    public void execute(int userId, Command command) throws IOException {
        ...
        bankingService.processCredit(userId, Arrays.asList(dollars, cents));
        outputPrinter.done();
    }
}
